    ...
    <div className="w-full h-full">
      ...
      <div className="flex flex-col justify-center items-center mt-16 h-48 space-y-8">
        <h1 className="text-black text-2xl font-semibold">
          Search For Your Favourite Organisations
        </h1>
        <div className="flex w-full max-w-sm items-center space-x-2">
          <Input className="text-lg focus-visible:ring-0" type="text" placeholder="Search organisations" onChange={(e) => setSearch(e.target.value)} />
          <Button
